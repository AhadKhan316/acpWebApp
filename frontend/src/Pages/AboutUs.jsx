  ...
  return (
    <section className="relative py-8 sm:py-10 lg:py-12 bg-white overflow-hidden">
      ...
      >
        ...
        >
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-800">
            About
          </h1>
        ...
        >
          <SectionWithSlider
            ...
            titleClassName="text-2xl sm:text-3xl lg:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-800 text-center"
            descriptionClassName="text-2xl sm:text-2xl md:text-3xl lg:max-w-4xl leading-relaxed mx-auto text-center text-gray-700"
          />
        </motion.div>
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <motion.h2
              className="text-2xl sm:text-3xl lg:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-800 mb-4"
              variants={itemVariants}
            >
              Our Vision
            </motion.h2>
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="p-8 bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-xl"
        >
          <div className="max-w-4xl mx-auto text-center">
            <motion.h2
              className="text-2xl sm:text-3xl lg:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-800 mb-4"
