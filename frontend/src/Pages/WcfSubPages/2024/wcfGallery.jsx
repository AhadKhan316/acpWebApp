...
import Wcfposter2025 from '/src/assets/wcf-assets/main-wcf-poster.jpeg';
...
const festivals = [
  {
    ...
    image: Wcfposter2025,
    description: "Experience a world without borders at the World Culture Festival - Karachi, the grandest global artistic gathering ever hosted in Pakistan. The event, a significant step in the Council's efforts of cultural diplomacy, is set to bring together over 450 artists from over 45 countries, across all continents to showcase the best talent in music, theatre, dance, and fine arts in a manner never seen before.",
    highlights: [
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2 p-6 lg:p-8 bg-gradient-to-br from-[#B90602]/5 to-[#E37A1E]/5">
              <div className="h-full flex flex-col">
                ...
                <Link to="/festival/wcf/wcfAlumniSessions">
                  <motion.div
