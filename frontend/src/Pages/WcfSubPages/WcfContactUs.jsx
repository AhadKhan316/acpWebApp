  ...
  const contactMethods = [
    {
      ...
      details: [
        { label: "Email", value: "info@wcfkarachi.com", href: "mailto:info@wcfkarachi.com" },
        { label: "Support", value: "support@wcfkarachi.com", href: "mailto:support@wcfkarachi.com" },
      ],
      bgColor: "bg-red-50",
    ...
    },
    {
      ...
      details: [
        { label: "Phone", value: "+92-21-1234567", href: "tel:+92211234567" },
        { label: "Hotline", value: "+92-300-1234567", href: "tel:+923001234567" },
      ],
      bgColor: "bg-red-50",
      borderColor: "border-red-100",
    },
    {
      ...
      details: [
        { label: "Address", value: "Karachi Expo Center, Pakistan" },
      ...
      <div className="relative h-96 md:h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent flex items-end pb-12">
          <div className="container mx-auto px-6 text-center">
            ...
            >
              Connect with the World Culture Festival Karachi
            </motion.p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <motion.div className="text-center mb-16" variants={itemVariants}>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Have questions about our festival? Want to collaborate or visit? We're here to assist.
          </p>
        </motion.div>
                  ...
                  <div key={i} className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      {detail.href ? (
                        <a
                          href={detail.href}
                          className="text-lg font-medium text-gray-900 hover:text-red-700 transition-colors"
                        >
                          {detail.value}
                        </a>
                      ) : (
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center">
                <motion.button
                  type="submit"
                  className="px-8 py-4 bg-gradient-to-r from-red-700 to-red-900 text-white font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
