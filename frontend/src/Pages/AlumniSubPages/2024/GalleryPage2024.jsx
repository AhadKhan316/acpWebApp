...
import poster2024 from '/src/assets/ArtsAlumniAssets/alumni-festival-assets-2024/alumni-main-poster.jpg';
...
const festivals = [
  {
    ...
    image: poster2024,
    description: "Arts Council Academies are set to hold their first-ever Convocation Ceremony & 1st Alumni Festival 2024. Join us as we celebrate the talent we have cultivated throughout the years.",
    highlights: [
    ...
    stats: [
      ...
      { value: "80+", label: "Alumni Celebrated" },
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2 p-6 lg:p-8 bg-gradient-to-br from-[#B90602]/5 to-[#E37A1E]/5">
              <div className="h-full flex flex-col">
                ...
                <Link to="/festival/aaf/firstAlumniSession">
                  <motion.div
