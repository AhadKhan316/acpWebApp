  ...
  const contactMethods = [
    {
      ...
      details: [
        { label: "Email", value: "info@auc.org", href: "mailto:info@auc.org" },
    ...
    },
    {
      ...
      details: [
        { label: "Address", value: "Karachi Arts Council, Karachi, Pakistan" },
      ...
      <div className="relative h-96 md:h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent flex items-end pb-12">
          <div className="container mx-auto px-6 text-center">
            ...
            >
              Connect with the Aalmi Urdu Conference
            </motion.p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <motion.div className="text-center mb-16" variants={itemVariants}>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Have questions about our conference? Reach out to our team for assistance.
          </p>
        </motion.div>
