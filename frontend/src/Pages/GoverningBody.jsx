...
import img7 from "../assets/governing-body-new/muhammad-iqbal-lateef.png";
import img8 from "../assets/governing-body-new/farrukh-tanveer-shahab.png";
import img9 from "../assets/governing-body-new/amjad-siraj-memon.png";
...
const GoverningBody = () => {
  ...
  // Define members with sorting for Co-opted Members and Governing Body only
  const members = {
    "Office Bearers": [
      { id: 1, name: "Munawar Saeed", description: "Vice President", image: img1, buttonText: "View Profile" },
      { id: 2, name: "Ejaz Ahmed Faruqi", description: "Secretary", image: img2, buttonText: "View Profile" },
      { id: 3, name: "Noorul Huda Shah", description: "Joint Secretary", image: img3, buttonText: "View Profile" },
    ...
    "Governing Body": [
      ...
      { id: 3, name: "Muhammad Iqbal Latif", description: "Member", image: img7, buttonText: "View Profile" },
      { id: 4, name: "Farrukh Tanveer Shahab", description: "Member", image: img8, buttonText: "View Profile" },
      { id: 5, name: "Amjad Sraj Memon", description: "Member", image: img9, buttonText: "View Profile" },
      { id: 6, name: "Ambareen Hasib Amber", description: "Member", image: img10, buttonText: "View Profile" },
      { id: 7, name: "Akhlaq Ahmed", description: "Member", image: img11, buttonText: "View Profile" },
      { id: 8, name: "Ghazi Salahuddin", description: "Member", image: img12, buttonText: "View Profile" },
      ...
      { id: 12, name: "Sayed Sajid Hasan", description: "Member", image: img16, buttonText: "View Profile" },
    ].sort((a, b) => a.name.localeCompare(b.name)).map((member, index) => ({ ...member, id: index + 1 })),
    "Co-opted Members": [
      { id: 1, name: "Waseem Badami", description: "Co-Opted Member", image: img17, buttonText: "View Profile" },
      { id: 2, name: "Jaffer Ahmed", description: "Co-Opted Member", image: img18, buttonText: "View Profile" },
      { id: 3, name: "Ghouse Akbar", description: "Co-Opted Member", image: img19, buttonText: "View Profile" },
      { id: 4, name: "Chand Gul Shah", description: "Co-Opted Member", image: img21, buttonText: "View Profile" },
      { id: 5, name: "Alya Iqbal Naqvi", description: "Co-Opted Member", image: img20, buttonText: "View Profile" },
    ].sort((a, b) => a.name.localeCompare(b.name)).map((member, index) => ({ ...member, id: index + 1 })),
  };

  // Transform items to remove description for Governing Body and Co-Opted Members
  const getTransformedItems = (tab) => {
    if (tab === "Governing Body" || tab === "Co-opted Members") {
      return members[tab].map((item) => ({ ...item, description: "" }));
    }
    return members[tab];
  };
    ...
    <div className="bg-white text-gray-900 py-12 px-4 sm:px-6 lg:px-8" id="governingBody">
      ...
      <div className="max-w-7xl mx-auto mb-16">
        ...
        >
          ...
          <Cards
            items={getTransformedItems(activeTab)}
