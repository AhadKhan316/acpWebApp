    ...
    <>
      ...
      >
        <div className="relative h-96 overflow-hidden rounded-2xl shadow-xl border-2 border-white/10 bg-gradient-to-br from-gray-900 to-gray-800">
          ...
          {/* Floating info panel */}
          <div className="absolute bottom-4 left-4 right-4 bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/10 transform group-hover:-translate-y-2 transition-transform duration-300">
            <h3 className="text-1xl font-bold text-white font-serif mb-1">{delegate.name}</h3>
            ...
            >
              <span className="inline-block px-4 py-1 text-sm font-medium bg-accent-500/90 text-white rounded-full shadow-lg">
                View Profile
              </span>
              <div className="ml-2 h-px bg-white/30 flex-1" />
            </motion.div>
          </div>
