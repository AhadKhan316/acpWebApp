...
const videosecttion = () => {
  ...
  return (
    <section className="w-full py-6 sm:py-8 bg-white text-red-800 overflow-hidden">
      ...
      >
        ...
        <p className="mt-2 text-base sm:text-xl text-black mx-4">
