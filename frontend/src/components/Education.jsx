    ...
    <section className="relative w-full py-12 px-6 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800">
            ...
            >
              <div className="flex items-start flex-grow">
                <div className="bg-pink-500/10 p-2 sm:p-3 rounded-lg mr-3 sm:mr-4 flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6 sm:w-8 sm:h-8 text-purple-500 fill-none stroke-current">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 19l-1.5-4.5M9 15h6M16.24 7.76l-1.41-1.41M7.76 7.76l1.41-1.41M12 12a3 3 0 100-6 3 3 0 000 6zm0 0v1.5M12 3v1.5m9 9H21m-18 0h1.5M16.95 16.95l1.05 1.05M6 18.6l1.05-1.05" />
                  </svg>
                </div>
                <div>
      ...
      {/* <Link to="/festival/aaf">
        <motion.div
          ...
          transition={{ delay: 0.4 }}
        >
          <button className="px-8 py-3 bg-white text-black font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer">
            Alumni
